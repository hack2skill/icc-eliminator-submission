...
export default function MetamaskLogin({ connectToWallet, connecting }) {
  return (
    <div className="max-w-sm rounded overflow-hidden shadow-lg bg-grey">
      <div className="px-6 py-4 flex flex-col justify-center relative">
        {connecting &&
          <div role="status" className=" absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 h-screen w-screen backdrop-blur-2xl bg-white/30">
        ...
        >
          ...
          <div className="px-2 inline pt-4 align-middle">
            <Image height={30} width={30} src="/metamask.svg" alt="MetaMask_Fox" className={"px-5"} />
          </div>
        </button>
      </div>
    </div>
