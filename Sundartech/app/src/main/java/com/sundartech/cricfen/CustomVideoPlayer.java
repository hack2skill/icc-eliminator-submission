...
public class CustomVideoPlayer extends LinearLayout {
    ...
    private ImageView backButton, volumeButton;
    ...
    private void initializeVideoPlayerView() {
        try {
            ...
            backButton = simpleExoPlayerView.findViewById(R.id.backButton);
            backButton.setOnClickListener(videoPlayerListener);

            volumeButton = simpleExoPlayerView.findViewById(R.id.volumeButton);
            volumeButton.setOnClickListener(videoPlayerListener);
    ...
    private void manageMute() {
        //volumeButton.setSelected(autoMute);
        if (autoMute) {
    ...
    private class VideoPlayerListener implements OnClickListener, SeekBar.OnSeekBarChangeListener, ExoPlayer.EventListener, VideoRendererEventListener, AudioRendererEventListener {
        ...
        public void onClick(View view) {
            ...
            if (viewId == R.id.backButton) {
                playbackListener.onBackPressed();
            }
        }
